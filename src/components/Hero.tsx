      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground mb-10 max-w-lg leading-relaxed">
            WIAN is a unique community designed to help and support people navigate life transitions, heal emotional wounds, and align with their soul's purpose through authentic energy work and intuitive coaching.
          </p>
